  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 50 50" fill="none" aria-hidden="true">
      <g stroke="currentColor" strokeWidth="3" strokeMiterlimit="10" strokeLinejoin="round" fill="none">
        ...
        <path d="M16.15,11.02v11.58c0,2.29-1.87,4.16-4.16,4.16h-.47c-2.28,0-4.15-1.87-4.15-4.16v-3.89l1.99-3.99,1.83-3.68s.02-.02.03-.02h4.93Z" />
        <path d="M24.93,11.02v11.58c0,2.29-1.87,4.16-4.15,4.16h-.47c-2.29,0-4.16-1.87-4.16-4.16v-11.58h8.78Z" />
        <path d="M33.72,11.02v11.58c0,2.29-1.87,4.16-4.16,4.16h-.47c-2.28,0-4.16-1.87-4.16-4.16v-11.58h8.79Z" />
        <path d="M33.89,11.02v11.58c0,2.29,1.87,4.16,4.16,4.16h.47c2.28,0,4.15-1.87,4.15-4.16v-3.89s-1.99-3.99-1.99-3.99l-1.83-3.68s-.02-.02-.03-.02h-4.93Z" />
        <path d="M42.67,18.79s0,.04-.03.04H7.47s-.09-.03-.1-.06v-.06l1.99-3.99,1.83-3.68s.02-.02.03-.02h27.57s.03.01.03.02l1.83,3.68,1.85,3.73.17.34Z" />
      </g>
    </svg>
  );
}
