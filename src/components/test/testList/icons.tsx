...
export function MarketplaceIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M2.5 1.5a1 1 0 0 0-.894.553L.606 4.053A.75.75 0 0 0 .5 4.5v1a2 2 0 0 0 1 1.732V13.5a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V7.232A2 2 0 0 0 15.5 5.5v-1a.75.75 0 0 0-.106-.447l-1-2A1 1 0 0 0 13.5 1.5zM14 5.5a1 1 0 0 1-2 0v-1a1 1 0 1 1 2 0zm-3 0a1 1 0 0 1-2 0v-1a1 1 0 1 1 2 0zm-3 0a1 1 0 0 1-2 0v-1a1 1 0 1 1 2 0zm-3 0a1 1 0 0 1-2 0v-1a1 1 0 1 1 2 0zM6.5 9a.5.5 0 0 0-.5.5V13h4V9.5a.5.5 0 0 0-.5-.5z" />
    </svg>
  );
}
