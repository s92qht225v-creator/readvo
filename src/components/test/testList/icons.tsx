  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 69.45 63.44" fill="none" aria-hidden="true">
      <g stroke="#000000" strokeWidth="5" strokeMiterlimit="10" strokeLinejoin="round" fill="none">
        ...
        <path d="M62.2,25.23v4.78c0,2.9-2.92,5.26-6.49,5.26h-.73c-3.58,0-6.51-2.37-6.51-5.26v-4.78" />
        <polygon points="60.88 22.85 8.58 22.85 13.15 12.64 56.31 12.64 60.88 22.85" />
      </g>
    </svg>
  );
}
...
export function SettingsIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 50 50" fill="none" aria-hidden="true">
      <g stroke="#000000" strokeWidth="4" strokeMiterlimit="10" strokeLinejoin="round" fill="none">
