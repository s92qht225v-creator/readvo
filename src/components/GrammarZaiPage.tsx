    ...
    <div className="grammar-page">
      <div className="grammar-page__hero">
        ...
        <div className="grammar-page__hero-body">
          ...
          <div className="grammar-page__hero-meaning">— {({ uz: 'bo\'lmoq / joylashgan bo\'lmoq', ru: 'находиться, быть (где-то)', en: 'to be at / to be located' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
