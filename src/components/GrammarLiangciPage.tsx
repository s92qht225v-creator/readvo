  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">量</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">量词</h1>
          <div className="dr-hero__pinyin">liàngcí</div>
          <div className="dr-hero__translation">— {({ uz: 'sanash so\'zlari', ru: 'счётные слова', en: 'measure words' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
