  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">了</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">了</h1>
          <div className="dr-hero__pinyin">le</div>
          <div className="dr-hero__translation">— {({ uz: 'tugallash / holat o\'zgardi', ru: 'завершение / изменение состояния', en: 'completion / change of state' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
