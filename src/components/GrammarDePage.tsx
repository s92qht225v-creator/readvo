...
const examples = [
  ...
  },
  {
    ...
    note_en: '漂亮 (piàoliang) = beautiful; 花 (huā) = flower',
  },
  {
    zh: '他的朋友很多。',
    ...
    note_en: '朋友 (péngyou) = friend; 很多 (hěn duō) = many',
  },
  {
    zh: '我买的东西很便宜。',
  ...
  },
  {
    ...
    note_en: '红色 (hóngsè) = red; 苹果 (píngguǒ) = apple',
  },
];
...
const omitExamples = [
  {
    ...
    label_en: 'Family members (can be omitted)',
    with_de: '我的妈妈',
  ...
  },
  {
    ...
    label_en: 'Monosyllabic adjectives (can be omitted)',
    with_de: '大的书',
  ...
  },
  {
    ...
    label_en: 'Multi-syllable adjectives (cannot be omitted)',
    with_de: '漂亮的花',
    ...
    tr_en: 'beautiful flower — 的 is required',
  },
];
    ...
    <div className="grammar-page">
      <div className="grammar-page__hero">
        ...
        <div className="grammar-page__hero-body">
          ...
          <div className="grammar-page__hero-meaning">— {({ uz: 'egalik / sifat bog\'lovchi', ru: 'притяжательная / атрибутивная частица', en: 'possessive / attributive particle' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
      ...
      <div className="grammar-page__content">
        ...
        {activeTab === 'intro' && (
          <>
              ...
              <div className="grammar-block__char-row">
                ...
                <div className="grammar-block__char-info">
                  ...
                  <div className="grammar-block__info-row">
                    ...
                    <span className="grammar-block__tone">{({ uz: 'neytral ton (·)', ru: 'нейтральный (·)', en: 'neutral tone (·)' } as Record<string, string>)[language]}</span>
                  </div>
                  <div className="grammar-block__info-row">
                    <span className="grammar-block__info-key">{({ uz: 'Ma\'nosi', ru: 'Перевод', en: 'Meaning' } as Record<string, string>)[language]}</span>
                    <span className="grammar-block__info-val">{({ uz: 'egalik / sifat bog\'lovchi', ru: 'притяжательная / атрибутивная частица', en: 'possessive / attributive particle' } as Record<string, string>)[language]}</span>
                  </div>
                  <div className="grammar-block__info-row">
            ...
            <div className="grammar-block">
              <div className="grammar-block__label">{({ uz: '是, 有, 在, 的 farqi', ru: 'Сравнение: 是, 有, 在, 的', en: 'Comparison: 是, 有, 在, 的' } as Record<string, string>)[language]}</div>
              {[
                {
                  type_uz: '是 — tenglashtirish (A = B)',
                  type_ru: '是 — равенство (A = B)',
                  type_en: '是 — equation (A = B)',
                  zh: '我<span class="grammar-block__highlight">是</span>学生。',
                  tr_uz: 'Men talabaman.',
                  tr_ru: 'Я студент.',
                  tr_en: 'I am a student.',
                },
                {
                  type_uz: '有 — egalik yoki mavjudlik',
                  type_ru: '有 — обладание / существование',
                  type_en: '有 — possession or existence',
        ...
        {activeTab === 'usage' && (
          <>
            <div className="grammar-block">
              <div className="grammar-block__label">{({ uz: '1. Egalik (possessive)', ru: '1. Притяжательность (egalik)', en: '1. Possession (possessive)' } as Record<string, string>)[language]}</div>
              ...
              <p className="grammar-block__formula-desc">
                {({ uz: 'Kimningdir narsasi, joyi yoki munosabatini bildiradi', ru: 'Показывает принадлежность: чья-то вещь, место или отношение', en: 'Shows possession: someone\'s thing, place, or relationship' } as Record<string, string>)[language]}
              </p>
              <div className="grammar-block__usage-item" style={{ marginTop: 10 }}>
                ...
                <div className="grammar-block__usage-tr">{({ uz: 'Bu mening sumkam.', ru: 'Это мой рюкзак.', en: 'This is my backpack.' } as Record<string, string>)[language]}</div>
              </div>
            </div>

            <div className="grammar-block">
              <div className="grammar-block__label">{({ uz: '2. Sifat bog\'lovchi (sifat + ot)', ru: '2. Атрибутивная связка (sifat + ot)', en: '2. Attributive link (adjective + noun)' } as Record<string, string>)[language]}</div>
              <div className="grammar-block__formula">
              ...
              <p className="grammar-block__formula-desc">
                {({ uz: 'Ko\'p bo\'g\'inli sifatlar otdan oldin 的 talab qiladi', ru: 'Многосложные прилагательные требуют 的 перед существительным', en: 'Multi-syllable adjectives require 的 before the noun' } as Record<string, string>)[language]}
              </p>
              <div className="grammar-block__usage-item" style={{ marginTop: 10 }}>
                ...
                <div className="grammar-block__usage-tr">{({ uz: 'chiroyli gul', ru: 'красивый цветок', en: 'beautiful flower' } as Record<string, string>)[language]}</div>
              </div>
            </div>

            <div className="grammar-block">
              <div className="grammar-block__label">{({ uz: 'Kishilik olmoshlari + 的', ru: 'Личные местоимения + 的', en: 'Personal pronouns + 的' } as Record<string, string>)[language]}</div>
              {[
                { pronoun: '我的', pinyin: 'wǒ de', uz: 'mening', ru: 'мой/моя/моё', en: 'my' },
                { pronoun: '你的', pinyin: 'nǐ de', uz: 'sening', ru: 'твой/твоя/твоё', en: 'your' },
                { pronoun: '他/她的', pinyin: 'tā de', uz: 'uning', ru: 'его/её', en: 'his/her' },
                { pronoun: '我们的', pinyin: 'wǒmen de', uz: 'bizning', ru: 'наш/наша', en: 'our' },
                { pronoun: '你们的', pinyin: 'nǐmen de', uz: 'sizlarning', ru: 'ваш/ваша', en: 'your (plural)' },
                { pronoun: '他们的', pinyin: 'tāmen de', uz: 'ularning', ru: 'их', en: 'their' },
              ].map((w, i) => (
        ...
        {activeTab === 'omit' && (
          <>
            <div className="grammar-block">
              <div className="grammar-block__label">{({ uz: 'Qachon 的 ni tushirish mumkin?', ru: 'Когда можно пропустить 的?', en: 'When can 的 be omitted?' } as Record<string, string>)[language]}</div>
              <p className="grammar-block__formula-desc">
                {({ uz: 'Yaqin munosabatlar (oila) va bir bo\'g\'inli sifatlarda 的 tushirilishi mumkin', ru: '的 можно опустить в близких отношениях (семья) и с односложными прилагательными', en: '的 can be omitted with close relationships (family) and monosyllabic adjectives' } as Record<string, string>)[language]}
              </p>
            </div>
              ...
              <div key={i} className="grammar-block grammar-block--tip">
                ...
                <div style={{ display: 'flex', gap: 12, marginTop: 8 }}>
                  <div className="grammar-block__usage-item" style={{ flex: 1, textAlign: 'center' }}>
                    <div className="grammar-block__usage-type">{({ uz: '的 bilan', ru: '的 с частицей', en: 'With 的' } as Record<string, string>)[language]}</div>
                  ...
                  <div className="grammar-block__usage-item" style={{ flex: 1, textAlign: 'center' }}>
                    <div className="grammar-block__usage-type">{({ uz: '的 siz', ru: 'Без частицы', en: 'Without 的' } as Record<string, string>)[language]}</div>
            ...
            <div className="grammar-block">
              <div className="grammar-block__label">{({ uz: 'Xulosa qoida', ru: 'Итоговое правило', en: 'Summary Rule' } as Record<string, string>)[language]}</div>
              {[
                {
                  label_uz: '✅ Tushirish mumkin',
                  label_ru: '✅ Можно пропустить',
                  label_en: '✅ Can be omitted',
                  items_uz: ['Oila a\'zolari: 我妈妈, 他爸爸', 'Bir bo\'g\'inli sifat: 大书, 好人'],
                  items_ru: ['Члены семьи: 我妈妈, 他爸爸', 'Односложные прилагательные: 大书, 好人'],
                  items_en: ['Family members: 我妈妈, 他爸爸', 'Monosyllabic adjectives: 大书, 好人'],
                },
                {
                  label_uz: '❌ Tushirib bo\'lmaydi',
                  label_ru: '❌ Нельзя пропустить',
                  label_en: '❌ Cannot be omitted',
                  ...
                  items_en: ['Multi-syllable adjectives: 漂亮的花, 高兴的人', 'Pronoun + noun (formal): 我的书, 她的包'],
                },
              ].map((rule, i) => (
                <div key={i} className="grammar-block__usage-item">
