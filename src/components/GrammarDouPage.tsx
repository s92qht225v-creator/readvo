  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">都</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">都</h1>
          <div className="dr-hero__pinyin">dōu</div>
          <div className="dr-hero__translation">— {({ uz: 'hammasi / barchasi', ru: 'все / всё', en: 'all / both' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
