...
const TAB_ICONS: Record<string, React.ReactNode> = {
  ...
  practice: (
    <svg viewBox="20.1 20.1 59.7 59.7" width="22" height="22" fill="currentColor" aria-hidden="true">
