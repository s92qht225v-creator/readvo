...
const TAB_ICONS: Record<string, React.ReactNode> = {
  ...
  vocab: (
    <svg viewBox="6.5 6.5 87.0 87.0" width="22" height="22" fill="currentColor" aria-hidden="true">
  ...
  practice: (
    <svg viewBox="14.8 14.8 70.3 70.3" width="22" height="22" fill="currentColor" aria-hidden="true">
