...
type ArTab = 'dialogues' | 'story' | 'flashcards';
...
const TAB_ICONS: Record<ArTab, React.ReactNode> = {
  ...
  story: <svg viewBox="0 0 100 100" width="28" height="28" style={{ width: 28, height: 28 }} fill="currentColor" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" strokeLinecap="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="m41.531 37.922h-24.984c-0.84375 0-1.5156-0.67188-1.5156-1.5156s0.67188-1.5156 1.5156-1.5156h24.984c0.84375 0 1.5156 0.67188 1.5156 1.5156s-0.6875 1.5156-1.5156 1.5156z"/><path d="m41.531 48.5h-24.984c-0.84375 0-1.5156-0.67188-1.5156-1.5156s0.67188-1.5156 1.5156-1.5156h24.984c0.84375 0 1.5156 0.67188 1.5156 1.5156s-0.6875 1.5156-1.5156 1.5156z"/><path d="m41.531 59.062h-24.984c-0.84375 0-1.5156-0.67188-1.5156-1.5156s0.67188-1.5156 1.5156-1.5156h24.984c0.84375 0 1.5156 0.67188 1.5156 1.5156s-0.6875 1.5156-1.5156 1.5156z"/><path d="m50.078 80.547c-0.20312 0-0.40625-0.046875-0.59375-0.125l-8.4531-3.5469h-33.219c-0.84375 0-1.5156-0.67188-1.5156-1.5156v-60.438c0-0.84375 0.67188-1.5156 1.5156-1.5156h33.531c0.39062 0 0.78125 0.15625 1.0625 0.4375l7.6719 7.5312 7.6875-7.5312c0.28125-0.28125 0.65625-0.4375 1.0625-0.4375h33.531c0.84375 0 1.5156 0.67188 1.5156 1.5156v60.453c0 0.84375-0.67188 1.5156-1.5156 1.5156h-33.219l-8.4688 3.5469c-0.20312 0.078125-0.39062 0.10938-0.59375 0.10938zm-40.75-6.6875h32.016c0.20312 0 0.40625 0.046875 0.59375 0.125l8.1406 3.4219 8.1719-3.4219c0.1875-0.078125 0.39062-0.125 0.57812-0.125h32.016v-57.422h-31.406l-8.3125 8.1406c-0.59375 0.57812-1.5312 0.57812-2.125 0l-8.2812-8.1406h-31.391z"/><path d="m83.641 37.922h-24.984c-0.84375 0-1.5156-0.67188-1.5156-1.5156s0.67188-1.5156 1.5156-1.5156h24.984c0.84375 0 1.5156 0.67188 1.5156 1.5156s-0.6875 1.5156-1.5156 1.5156z"/><path d="m83.641 48.5h-24.984c-0.84375 0-1.5156-0.67188-1.5156-1.5156s0.67188-1.5156 1.5156-1.5156h24.984c0.84375 0 1.5156 0.67188 1.5156 1.5156s-0.6875 1.5156-1.5156 1.5156z"/><path d="m83.641 59.062h-24.984c-0.84375 0-1.5156-0.67188-1.5156-1.5156s0.67188-1.5156 1.5156-1.5156h24.984c0.84375 0 1.5156 0.67188 1.5156 1.5156s-0.6875 1.5156-1.5156 1.5156z"/><path d="m50.109 86.594c-2.6406 0-5.1875-0.84375-7.6719-2.5469h-40.922c-0.84375 0-1.5156-0.67188-1.5156-1.5v-62.562c0-0.84375 0.67188-1.5156 1.5156-1.5156s1.5156 0.67188 1.5156 1.5156v61.031h39.891c0.32812 0 0.625 0.09375 0.89062 0.29688 4.125 3 8.4219 2.9844 13.141-0.046875 0.25-0.15625 0.53125-0.23438 0.8125-0.23438h39.188v-60.156c0-0.84375 0.67188-1.5156 1.5156-1.5156s1.5312 0.67188 1.5312 1.5v61.672c0 0.84375-0.67188 1.5156-1.5156 1.5156h-40.266c-2.7656 1.7031-5.4688 2.5469-8.1094 2.5469z"/><path d="m50.078 80.547c-0.84375 0-1.5156-0.67188-1.5156-1.5156v-55.547c0-0.84375 0.67188-1.5156 1.5156-1.5156s1.5156 0.67188 1.5156 1.5156v55.547c0 0.84375-0.67188 1.5156-1.5156 1.5156z"/></svg>,
};
...
const TAB_META: Record<ArTab, { href: string; ar: string; translit: string; uz: string; ru: string; en: string }> = {
  ...
  story: { href: '/arabic/story', ar: 'قصة', translit: 'qiṣṣa', uz: 'Hikoyalar', ru: 'Истории', en: 'Stories' },
...
const TAB_LABELS: Record<ArTab, { uz: string; ru: string; en: string }> = {
  ...
  story: { uz: 'Hikoya', ru: 'История', en: 'Story' },
  flashcards: { uz: 'Fleshkarta', ru: 'Флешкарты', en: 'Flashcards' },
};

const ORDER: ArTab[] = ['dialogues', 'story', 'flashcards'];
