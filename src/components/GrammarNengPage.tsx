  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">能</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">能</h1>
          <div className="dr-hero__pinyin">néng</div>
          <div className="dr-hero__translation">— {({ uz: '...a olmoq (imkoniyat)', ru: 'мочь (возможность)', en: 'can; to be able to (possibility)' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
