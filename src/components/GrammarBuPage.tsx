  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">不</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">不</h1>
          <div className="dr-hero__pinyin">bù</div>
          <div className="dr-hero__translation">— {({ uz: 'inkor yuklamasi / «emas»', ru: 'отрицательная частица / «не»', en: 'negative particle / "not"' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
