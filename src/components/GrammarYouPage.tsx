  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">有</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">有</h1>
          <div className="dr-hero__pinyin">yǒu</div>
          <div className="dr-hero__translation">— {({ uz: 'bor bo\'lmoq / ega bo\'lmoq', ru: 'иметь, существовать', en: 'to have / there is' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
