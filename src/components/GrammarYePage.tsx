  ...
  return (
    <div className="grammar-page">
      <div className="dr-hero">
        <div className="dr-hero__watermark">也</div>
        ...
        <div className="dr-hero__body">
          ...
          <h1 className="dr-hero__title">也</h1>
          <div className="dr-hero__pinyin">yě</div>
          <div className="dr-hero__translation">— {({ uz: 'ham / ...ham', ru: 'тоже / также', en: 'also / too' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
