    ...
    <div className="grammar-page">
      <div className="dr-hero">
        ...
        <div className="dr-hero__body">
          ...
          <div className="dr-hero__translation">— {({ uz: 'davom yuklamasi / «senchi?»', ru: 'продолжительная частица / «а ты?»', en: 'continuation particle / "and you?"' } as Record<string, string>)[language]} —</div>
        </div>
      </div>
