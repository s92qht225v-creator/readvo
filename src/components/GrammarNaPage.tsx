...
const dialog2: { s: string; parts: Part[]; py: string; uz: string; ru: string; en: string }[] = [
  ...
  { s:'B', parts:[{text:'我喜欢',color:C_SUB},{text:'这个。那个',color:C_PRED},{text:'是',color:C_SHI},{text:'什么',color:C_SHENME},{text:'？',color:C_PUNC}],               py:'Wǒ xǐhuān zhè ge. Nà ge shì shénme?', uz:"Men buni yaxshi ko'raman. U nima?",    ru:'Мне нравится этот. А что то?',        en:"I like this one. What is that?" },
