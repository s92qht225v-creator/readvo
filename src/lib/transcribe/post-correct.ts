    ...
    messages: [
      {
        ...
        content: [
          ...
          'If the Heard sentence contains homophone errors (wrong characters that sound the SAME as the expected ones, e.g. 封斋→风寨, 认识→人事), fix them.',
          'CRITICAL: If the Heard sentence has a DIFFERENT meaning or different sounds from the Expected (e.g. 很开心 vs 在封斋, 你好 vs 我好), return the Heard sentence UNCHANGED. Do NOT force-match to the expected.',
