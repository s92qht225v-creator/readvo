...
export default async function DialoguePage({ params }: PageParams) {
  ...
  const jsonLd = jsonLdScript([
    breadcrumbJsonLd([
      ...
      { name: `${raw.title} — ${translation}`, path: `/${locale}/chinese/hsk3/dialogues/${dialogueId}` },
    ]),
    {
      '@type': 'LearningResource',
      name: `${raw.title} (${raw.pinyin}) — ${translation}`,
      description: `HSK 3 Chinese dialogue: ${raw.title} — ${translation}`,
  ...
  return (
    <>
      ...
      <DialogueReader
        ...
        listPath="/chinese?tab=dialogues&dialhsk=3"
      />
    </>
  );
}
